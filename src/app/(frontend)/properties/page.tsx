                  ...
                  <div className="flex-1">
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="w-full bg-transparent border-none text-white placeholder-gray-400 pl-12 pr-4 py-4 focus:outline-none text-lg"
                      />
                    </div>
                  </div>
                  <button 
          ...
          <div className="bg-white rounded-2xl shadow-2xl p-6 border border-gray-100">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full px-4 py-2.5 bg-gray-100 rounded-lg border-none focus:ring-2 focus:ring-amber-500 focus:outline-none text-gray-700"
                >
            ...
            <div className="mt-6 pt-6 border-t border-gray-100 grid grid-cols-2 md:grid-cols-4 gap-4">
              ...
              <div className="text-center">
                ...
                <div className="text-gray-600 text-sm">Property Types</div>
              </div>
              <div className="text-center">
                <div className="text-2xl font-bold text-gray-900">
                  {Math.round(properties.reduce((acc, p) => acc + p.rating, 0) / properties.length)}%
                </div>
                <div className="text-gray-600 text-sm">Avg. Satisfaction</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="bg-gradient-to-r from-gray-900 to-blue-900 py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link
              href="/valuation"
              className="bg-white/10 backdrop-blur-sm text-white font-semibold px-8 py-4 rounded-xl hover:bg-white/20 transition-all duration-300 border border-white/20"
            >
              Get Free Valuation
            </Link>
          </div>
